    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (var file = new StreamWriter(filePath))
            {
                ...
                world.Add(new Sphere(new Vector3(0, 0, -1), 0.5f, new Lambertian(new Vector3(0.7f, 0.3f, 0.3f))));
                world.Add(new Sphere(new Vector3(0, -100.5f, -1), 100, new Lambertian(new Vector3(0.8f, 0.8f, 0.0f))));

                world.Add(new Sphere(new Vector3(1, 0, -1), 0.5f, new Metal(new Vector3(.8f, .6f, .2f), 1.0f)));
                world.Add(new Sphere(new Vector3(-1, 0, -1), 0.5f, new Metal(new Vector3(.8f, .8f, .8f), 0.3f)));
